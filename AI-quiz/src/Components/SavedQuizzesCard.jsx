...
export const SavedQuizzesCard = ({setSavedIsClicked, savedIsClicked, savedPopup, setSavedPopup, setQuestions, setQuestionCount, setOptions, setCorrectAnswer, setLoading}) => {
  return (
